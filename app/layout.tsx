...
function LinkItem({ href, title }: { title: string; href: string }) {
  return (
    <Link href={href} className="text-sm text-tint hover:text-tint-alt">
      {title}
    </Link>
  );
}
...
function CoursesDropdown() {
  return (
    <DropdownMenu>
      <DropdownMenuTrigger className="text-sm text-tint hover:text-tint-alt flex items-center">
