    ...
    return <section className="w-full flex flex-col">
        <Container className="flex items-start flex-row lg:flex-row flex-1">
            <div className="w-[70%] hidden md:flex lg:hidden">
                ...
                <span className="font-bold text-[29.1px] md:text-[39.76px] md:leading-[55px] lg:text-[43px] text-tint-b leading-[57px] pr-5">
            ...
            <div className="flex">
                <div className="flex-1 flex flex-col justify-center">
                    ...
                    <p className="font-wa font-[500] text-[14px] leading-[26px] text-[#5B5B5B] mt-[16px]">
        ...
        <Container className="w-full flex !flex-row !items-start lg:!items-center -mt-28 justify-between md:justify-normal md:hidden lg:flex">
            <IconButton Icon={Whatsapp} title="Whatsapp" url="/aviation" />
            <VLine />
            <IconButton Icon={Phone} title="Enquire Now" url="/aviation" />
            <VLine />
            <IconButton Icon={Cloud} title="Download Broucher" url="/aviation" />
            <div className="flex-1 items-center bgbl hidden lg:flex">
        ...
        <Container className="!flex-row items-center hidden md:flex lg:hidden py-0 -mt-28">
            <div className="h-[2px] flex-1 bg-[#70DDF0]" />
            <Node />
        </Container>
    </section>
