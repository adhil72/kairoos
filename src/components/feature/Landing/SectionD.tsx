        ...
        <Container className="min-h-[80vh]">
            <div className="flex-1 flex relative">
                ...
                <div className="flex-1 relative flex items-center justify-center flex-col">
                    ...
                    <span className="font-[400] text-[49px] leading-[57px] px-40 text-center z-10 text-[#187593]">
                        We Give Top Courses of Today’s Job Market
                    </span>
                    <p className="px-40 font-wa font-[500] text-[14px] leading-[26px] z-10 text-center">
