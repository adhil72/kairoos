...
export default function SectionG() {
    return <section className="w-full mb-16 min-h-[50vh]">
        <Container className="lg:flex-row items-center">
            <div>
            ...
            <div className="flex-1 px-10 mt-5 lg:mt-0">
                <span className="capitalize font-[400] text-[35px] leading-[37px] bg-gradient-to-r from-[#2FC5E1] to-[#0C3040] bg-clip-text text-transparent">Do you want to speak to <br />
                    our career consultant?</span>
                <p className="text-[#5B5B5B] font-wa font-[500] text-[14px] leading-[26px] mt-[20px]">
                ...
                <div className="relative h-fit hidden md:flex mt-[45px]">
                    <div>
        ...
        <div className="mb-32 w-full flex justify-center md:hidden -mt-16">
