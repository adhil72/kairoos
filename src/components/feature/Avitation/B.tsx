...
export default function B() {
    return <Container className="bg-[#EDFDFE] py-16">
        <div className="w-full mx-auto text-center max-w-[907px]">
            <h2 className="text-[29px] md:text-[39px] lg:text-[43px] font-bold text-[#187593] leading-[39px] md:leading-[55px] lg:leading-[57px]">
                Best Aviation Institute in Kerala & Bangalore
            </h2>
            <h2 className="text-[18px] md:text-[29px] lg:text-[43px] text-[#187593] mb-2 lg:mb-4 leading-[39px] lg:leading-[55px]">
                100% Placement Assistance
            </h2>
            <span className="text-[15px] md:text-[14px] leading-[25px] md:leading-[26px] font-semibold font-wa text-[#5B5B5B] my-6 pb-3 mx-auto max-w-[907px]">
            ...
            <div className="bg-white text-[#187593] py-4 px-5 rounded-[45px] text-left max-w-4xl border-tint-alt border-2 flex mt-6 flex-col lg:flex-row">
                <div className='w-full text-center lg:text-start font-semibold'>
                ...
                <div className="flex px-6 gap-4 flex-col lg:flex-row flex-1">
                    <button className='bg-tint-alt rounded-3xl text-white p-2 hover:bg-[#187593] flex-1'>Enroll Now</button>
